                ...
                <div className="page-content-top">
                  ...
                  <div className="search-users">
                    <label className="label-field" htmlFor="search">
                      <input className="input-search-users" type="text" name="search" />
                      <span>Поиск: </span>
                    </label>
                              ...
                              {item.profile.avatar ? (
                                ...
                                <div
                                  ...
                                  <span className="null-avatar-title">
                                    {!!item.profile.firstname && item.profile.firstname[0]}
                                    {!!item.profile.lastname && item.profile.lastname[0]}
                                  </span>
                                </div>
                              )}
                            </td>
